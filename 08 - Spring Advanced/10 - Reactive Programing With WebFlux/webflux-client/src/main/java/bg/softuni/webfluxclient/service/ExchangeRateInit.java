...
import bg.softuni.webfluxclient.ExchangeRateClient;
import bg.softuni.webfluxclient.model.ExchangeRate;
import bg.softuni.webfluxclient.model.ExchangeRateRepository;
...
public class ExchangeRateInit implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public ExchangeRateInit(ExchangeRateClient client,
