...
-- At the end you have to sum the difference between the deposits. At the end your query should return a single value: the SUM of all differences.
...
-- Detailed query for better understanding
SELECT 
...
-- Then increase the salaries of all high paid employees with department_id = 1 with 5000 in the new table. Finally, select the average salaries 
-- in each department from the new table. Sort result by department_id in increasing order.
