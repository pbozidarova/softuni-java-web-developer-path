...
public final class CrazyMapper {
    ...
    public static <D> D createMapping(Object source, Class<D> returnClass) throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchFieldException {
