...
public class TaskController {
    ...
    public String edit(@PathVariable("id") Integer id, Model model){
        ...
        TaskBindingModel taskBindingModel = new TaskBindingModel(t.getId(), t.getTitle(), t.getComments());
    ...
    @PostMapping("/edit/{id}")
    public String delete(@PathVariable("id") Integer id, TaskBindingModel model){
        Task t = this.taskRepository.findById(id).get();
